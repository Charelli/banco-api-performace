...
🔗 Repositório: [https://github.com/Charelli/banco-api-performace.git](https://github.com/Charelli/banco-api-performace.git)
...
```bash
git clone https://github.com/Charelli/banco-api-performace.git
